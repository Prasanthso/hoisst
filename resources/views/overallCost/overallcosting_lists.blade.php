...
<main id="main" class="main">
    ...
    <div class="pagetitle d-flex px-4 pt-4 justify-content-between">
        ...
        <!--<button id="exportExcel" class="btn btn-primary">Export</button>-->
    </div>
    </div><!-- End Page Title -->
...
<script>
    ...
    */
      ...
      const updateSelectAllState = () => {
        ...
        // const table = document.querySelector('overallcostingTable'); // Adjust the selector if needed
        // const wb = XLSX.utils.table_to_book(table, { sheet: 'Sheet1' });
        // XLSX.writeFile(wb, 'overall_costing.xlsx');
    // });
    ...
    function exportPdf()
    {
        ...
        rows.forEach((row, rowIndex) => {
            ...
            cells.forEach((cell, colIndex) => {
                doc.text(cell.innerText, 10 + colIndex * 50, startY + rowIndex * 10); // Adjust position
            });
        });

        doc.save('overall_costingPdf.pdf');
    }
