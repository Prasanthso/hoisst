...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        View::composer('layouts.headerNav', function ($view) {
            ...
            $view->with('productPriceThresholdCollection', $productPriceThresholdCollection);

            $productPriceAlertCollection = collect($productPriceAlert);
            $view->with('productPriceAlertCollection', $productPriceAlertCollection);

            $rawMaterialsPriceThresholdCollection = collect($rawMaterialsPriceThreshold);
            $view->with('rawMaterialsPriceThresholdCollection', $rawMaterialsPriceThresholdCollection);

            $rawMaterialsPriceAlertCollection = collect($rawMaterialsPriceAlert);
            $view->with('rawMaterialsPriceAlertCollection', $rawMaterialsPriceAlertCollection);

            $packingMaterialsPriceThresholdCollection = collect($packingMaterialsPriceThreshold);
            $view->with('packingMaterialsPriceThresholdCollection', $packingMaterialsPriceThresholdCollection);

            $packingMaterialsPriceAlertCollection = collect($packingMaterialsPriceAlert);
            $view->with('packingMaterialsPriceAlertCollection', $packingMaterialsPriceAlertCollection);
        });
    }
}
