...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('overall_costing', function (Blueprint $table) {
            ...
            $table->decimal('rm_sg_mrp', 10, 2)->default(0);
            $table->decimal('pm_sg_mrp', 10, 2)->default(0);
            $table->decimal('sg_mrp', 10, 2)->default(0);
            $table->decimal('sg_margin', 10, 2)->default(0);
            $table->decimal('oh_amt', 10, 2)->default(0);
            $table->decimal('total_cost', 10, 2)->default(0);
            $table->decimal('sell_rate', 10, 2)->default(0);
            $table->decimal('sell_rate_bf', 10, 2)->default(0);
            $table->decimal('tax', 10, 2)->default(0);
            $table->decimal('margin_amt', 10, 2)->default(0);
            $table->decimal('discount', 10, 2)->default(0);
            $table->decimal('present_mrp', 10, 2)->default(0);
